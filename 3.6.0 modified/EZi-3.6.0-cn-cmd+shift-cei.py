...
class Api:
    ...
    def _resolve_helper_cei_dir(self):
        d = os.path.normpath(os.path.join(ROOT_DIR, 'Add-Ons', 'Tools', 'Helper-CEI'))
        return d if os.path.isdir(d) else None
    ...
    def open_sub_folder(self, folder_type):
        ...
        elif folder_type == 'helper_cei':
            path = self._resolve_helper_cei_dir()
        else:
            return
